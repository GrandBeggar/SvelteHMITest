...
export const firstPassSymbols = [
  ...
  { key: 'hopperNotEmpty', label: 'Hopper Not Empty', symbol: conn.hopperNotEmpty, group: 'Inputs' },
  ...
  { key: 'outfeedConveyorOut', label: 'Outfeed Conveyor', symbol: conn.outfeedConveyorOut, group: 'Outputs' },
  { key: 'backStopsOut', label: 'Back Stops Output', symbol: conn.backStopsOut, group: 'Outputs' },
  { key: 'recipeMaxCount', label: 'Recipe Max Count', symbol: conn.recipeMaxCount, group: 'Recipe' },
  ...
  { key: 'traysPerMinute', label: 'Trays Per Minute', symbol: conn.traysPerMinute, group: 'Metrics' },
  { key: 'traysLastMinute', label: 'Trays Last Minute', symbol: conn.traysLastMinute, group: 'Metrics' },
